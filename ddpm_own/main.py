...
diffusion = Diffusion(num_steps=1000, img_shape=(3, 32, 32), device=DEVICE)
...
for epoch in range(1, EPOCHS):
    ...
    if epoch % 20 == 0:
        ...
        plt.savefig('ddpm_own/outputs/noisy_grid_img.png')


torch.save(model.state_dict(), 'ddpm_own/model.pt')
